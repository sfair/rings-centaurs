...
DLLEXPORT int reb_collision_resolve_hard(struct reb_simulation* const r, struct reb_collision c);
DLLEXPORT int reb_collision_merge(struct reb_simulation* const r, struct reb_collision c);
